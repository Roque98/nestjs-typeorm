...
export class createCategories1620872812070 implements MigrationInterface {
    name = 'createCategories1620872812070'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "category" DROP COLUMN "name"`);
        await queryRunner.query(`ALTER TABLE "category" ADD "name" character varying(50) NOT NULL`);
